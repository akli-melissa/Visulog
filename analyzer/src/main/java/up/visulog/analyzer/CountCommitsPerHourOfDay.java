...
public class CountCommitsPerHourOfDay implements AnalyzerPlugin {
    ...
    static class Result implements AnalyzerPlugin.Result {
        private final Map<String, Integer> commitsPerHourOfWeek = new HashMap<>();// pour chaque user un nombre de
                                                                                  // commits
        ...
        public String getResultAsHtmlDiv() {
            ...
            html.append("\ndatasets: [{label: 'Commits per day hour',data:").append(data)
                    .append(",fill: false,borderColor: 'rgb(75, 192, 192)',tension: 0.1}]};");
